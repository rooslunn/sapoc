...
class Offers_Controller extends Base_Controller {
    ...
    private function new_offer($offer_type) {
        $fields = array(
            ...
            '-',
            'from_country' => array('class' => 'live-country'),
            'from_state'   => array('class' => 'live-district'),
            'from_town'    => array('class' => 'live-town'),
            '-',  
            'to_country'   => array('class' => 'live-country'),
            'to_state'     => array('class' => 'live-district'),  
            'to_town'      => array('class' => 'live-town'),
            '-',   
